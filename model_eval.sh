...
python3 train.py -n std-f5-c3 -ncf 5 -ncp 3 -e 500
python3 train.py -n std-f10-c3 -ncf 10 -ncp 3 -e 500
python3 train.py -n std-f25-c3 -ncf 25 -ncp 3 -e 500
python3 train.py -n std-f50-c3 -ncf 50 -ncp 3 -e 500
python3 train.py -n std-f100-c3 -ncf 100 -ncp 3 -e 500
python3 train.py -n std-f5-c5 -ncf 5 -ncp 5 -e 500
python3 train.py -n std-f5-c10 -ncf 5 -ncp 10 -e 500
python3 train.py -n std-f5-c20 -ncf 5 -ncp 20 -e 500
